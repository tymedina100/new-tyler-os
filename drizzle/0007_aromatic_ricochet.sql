...
(
  'cursor',
  'Cursor Pro',
  'example_cursor_pro_coding',
  'Cursor Pro coding (example)',
  70,
  'percent',
  'estimated',
  'monthly',
  TIMESTAMPTZ '2026-10-01 07:00:00+00',
  'America/Phoenix',
  TIMESTAMPTZ '2026-09-04 20:00:00+00',
  NULL,
  'Example / mock — not a real Tyler subscription limit.',
  true
),
(
  'xai',
  'Grok Bot',
  'example_grok_bot_weekly',
  'Grok Bot weekly (example)',
  80,
  'percent',
  'estimated',
  'weekly',
  TIMESTAMPTZ '2026-09-08 07:00:00+00',
  'America/Phoenix',
  TIMESTAMPTZ '2026-09-04 20:00:00+00',
  NULL,
  'Example / mock — not a real Tyler subscription limit.',
...
(
  'anthropic',
  'Claude subscription',
  'example_claude_subscription',
  'Claude subscription (example)',
  55,
  'percent',
  'estimated',
  'monthly',
...
(
  'google',
  'Gemini subscription',
  'example_gemini_subscription',
  'Gemini subscription (example)',
  90,
  'percent',
  'estimated',
  'monthly',
...
(
  'openai',
  'PAYG API',
  'example_openai_payg_api',
  'PAYG API budget (example)',
  25,
  'usd',
  'estimated',
  'monthly',
